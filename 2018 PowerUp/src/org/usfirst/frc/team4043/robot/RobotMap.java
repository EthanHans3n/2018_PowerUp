...
public class RobotMap {
	...
	public static WPI_TalonSRX intakeFL = new WPI_TalonSRX(2);
	public static WPI_TalonSRX intakeFR = new WPI_TalonSRX(3);
	public static WPI_TalonSRX intakeBL = new WPI_TalonSRX(4);
